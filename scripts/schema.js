window.board = [
  {
    ...
    questions: [
        ...
        {
          cost: 200,
          question: 'Именно столько лет Алексей и Танюша живут в СПб',
          type: 'text',
          answer: null,
          isActive: true
        },
  ...
  },
  {
    ...
    questions: [
        ...
        {
          cost: 200,
          question: 'Алексей утверждает, что онажды, лично видел этого писателя. Хотя, если как следует разобраться - это, скорее всего, была просто такая рябь на глади реальности.',
          type: 'text',
          answer: null,
          isActive: true
        },
        ...
        },
        {
          ...
          answer: {
            type: 'img',
            media: 'media/crem.jpeg'
          },
          isActive: true
        },
        {
          cost: 500,
          question: 'Оказывается, ТАКИМИ бывают чтения, спички, фильмы, лыжи и даже пельмени. Назовите любой ТАКИХ фильмов.',
          type: 'text',
          answer: {
            type: 'img',
  ...
  },
  {
    category: "Верю-Не верю",
      questions: [
        ...
        {
          cost: 100,
          question: 'В самлм начале знакомства Алексей и Танюша, в атмосфере фильмов про хакеров выкладывали в сеть видеоклип о любовной связи Сами Знаете Кого с Сами Знаете Кем.',
          type: 'text',
          answer: {
            type: 'mp4',
            media: 'media/navalny_and_putin_are_gay.mp4'
          },
          isActive: true
        },
        {
  ...
  },
  {
    ...
    questions: [
      {
        cost: 100,
        question: 'Несмотря на это неприятное происшествие, Танюша успешно сдала экзамен на водительские права.',
        type: 'text',
        answer: null,
        isActive: true
      },
  ...
  },
  {
    ...
    questions: [
        {
          cost: 100,
          question: 'Невеста и жених оба ненавидят эту песню про свадьбу. Хочется считать, что ненавидят эту песню и небо и земля. А первым спел её Муслим Магомаев. Напойте эту песню.',
          type: 'text',
          answer: null,
          isActive: true
        },
